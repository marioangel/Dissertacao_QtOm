...
Com o intuito de implementar \textit{containers} associativos, um ponteiro $c_v$ é definido para os valores armazenados, um ponteiro $c_k$ é utilizado para armazenar as chaves do respectivo \textit{container} e uma variável $c_{size}$ é utilizada para guardar a quantidade de elementos inseridos. Em particular, $c_k$ e $c_v$ estão conectados através de um índice, ou seja, dado um container $c$ que contém uma chave $k$ e um valor $v$ assume-se que
