...
O objetivo geral deste trabalhar é aplicar as técnicas de verificação utilizando modelos operacionais para verificar aplicações que utilizam o framework Qt, usando ESBMC$++$(\textit{Efficient SMT-based bounded model checker}), LLBMC e DIVINE como ferramentas de verificação.
...
\begin{itemize}
  ...
  \item Verificar o acesso de memória inválida, valores de tempo e período, o acesso a arquivos ausentes, ponteiros nulos, a manipulação de cadeia de caracteres(strings), uso de containers, entre outras propriedades das aplicações Qt.
  \item Aplicar a metodologia de verificação propostas em aplicações reais que utilizam Qt.
\end{itemize}
