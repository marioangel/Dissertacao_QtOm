...
Com o intuito de avaliar a eficácia da abordagem proposta a cerca da verificação de programas que utilizam o \textit{framework} Qt, um conjunto de testes automáticos denomidado \textit{esbmc--qt} foi criado. Em resumo, este conjunto de testes contém $711$ programas Qt/C$++$ ($12903$ linhas de código), ou seja, todos os casos de teste utilizadas na atual avaliação.
