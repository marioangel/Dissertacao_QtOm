...
Por fim, se uma violação em alguma propriedade for encontrada, um contraexemplo é gerado por ESBMC++, o qual atribui valores as variáveis de programa, com o intuito de reproduzir o erro encontrado. De fato, contraexemplos possuem grande importância para o diagnóstico e a análise da execução do programa, dado que as violações encontradas pode ser sistematicamente rastreadas \textcolor{red}{citar este artigo: Herbert Rocha, Raimundo S. Barreto, Lucas C. Cordeiro, Arilo Dias Neto: Understanding Programming Bugs in ANSI-C Software Using Bounded Model Checking Counter-Examples. IFM 2012: 128-142}. 
