...
\node [below of = c21, xshift=25pt] (c211) {\textit{int} a};
\node [below of = c211] (c212) {\textit{int} b};
\node [below of = c212] (c213) {\textit{int} c};
\end{scope}
...
\begin{scope}[every node/.style={level 3}]
\node [below of = c22, xshift=25pt] (c221) {\textit{int} r};
\end{scope}
