...
Comparando com ~\cite{monteiro2015}, este trabalho o QtOM inclui atualmente uma representação inicial para todas as bibliotecas do módulo \textit{QtCore} e \textit{QtGui}, assim como fornece um suporte completo à todas as classes \textit{container} que são amplamente utilizadas em aplicações reais.
